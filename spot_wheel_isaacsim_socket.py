...
class SpotContactController:
    def __init__(self, physics_dt, render_dt):
        ...
        # model, jit_model = extract_pytorch_model_from_jit("./assets/spot_policy_custom_rslrl.pt")
        # model, jit_model = extract_pytorch_model_from_jit("./assets/spot_policy_ftd3_hop.pt")
        # model, jit_model = extract_pytorch_model_from_jit("./assets/spot_fast_td3_final.pt")
        # model, jit_model = extract_pytorch_model_from_jit("./assets/rslrl_ppo_3B_policy.pt")
